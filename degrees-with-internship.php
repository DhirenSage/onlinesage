<?php include ('header.php'); ?>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Degrees with Internship</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="course-info">
                        <h1>Online Degree with Internship Programs</h1>
                        <p class="tagline">Learn. Experience. Excel.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="hero-form">
    ...
    <section id="overview" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <p style="font-size: 16px; line-height: 1.8; text-align: justify;">Combine academic excellence with
                        workplace immersion. Earn your degree while building professional experience, industry
                        connections, and practical skills that make you job-ready from graduation day.</p>
                </div>
                <div class="col-lg-5">
                    <div class="eligibility-card">
                        <h3>Benefits:</h3>
                        <ul>
                            <li><b>Hands-on industry experience</b> during studies</li>
                            <li><b>Potential earning opportunities</b> while learning</li>
                            <li><b>Professional mentoring</b> and network building</li>
                            <li><b>Enhanced job readiness</b></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            ...
                                            <div class="program-buttons">
                                                <a href="bca-honours-with-internship.php"
                                ...
                                <div class="col-lg-4 col-md-6 d-none d-md-block">
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            <h3>MCA</h3>
                                            <div class="program-buttons">
                                                <a href="mca-with-internship.php" class="btn btn-outline-primary">View
                                                    Details</a>
                                                <a href="#apply" class="btn btn-primary-custom">Apply Now</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            <h3>MBA</h3>
                                            <div class="program-buttons">
                                                <a href="mba-with-internship.php" class="btn btn-outline-primary">View
                                                    Details</a>
                                                <a href="#apply" class="btn btn-primary-custom">Apply Now</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            ...
                                            <div class="program-buttons">
                                                <a href="mba-banking-with-internship.php"
                                                    class="btn btn-outline-primary">View
                                                    Details</a>
                                                <a href="#apply" class="btn btn-primary-custom">Apply Now</a>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 d-none d-md-block">
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            <h3>M.Com</h3>
                                            <div class="program-buttons">
                                                <a href="mcom-with-internship.php" class="btn btn-outline-primary">View
                                                    Details</a>
                                                <a href="#apply" class="btn btn-primary-custom">Apply Now</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            <h3>MA Journalism</h3>
                                            <div class="program-buttons">
                                                <a href="ma-journalism-and-mass-communication-with-internship.php"
                                                    class="btn btn-outline-primary">View
                                                    Details</a>
                                                <a href="#apply" class="btn btn-primary-custom">Apply Now</a>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="program-card">
                                        ...
                                        <div class="program-content">
                                            <h3>M.Sc Maths</h3>
                                            <div class="program-buttons">
                                                <a href="msc-mathematics-with-internship.php"
                                                    class="btn btn-outline-primary">View
                                                    Details</a>
                                                <a href="#apply" class="btn btn-primary-custom">Apply Now</a>
                                            </div>
