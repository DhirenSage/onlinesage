        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">BCA (Hons.) - Degree with Internship</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="course-info">
                        <h1>BCA (Hons.) - Degree with Internship</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p style="font-size: 16px; line-height: 1.8; text-align: justify;">SAGE's BCA Honours with Research
                        (Degree with Internship) uniquely blends computing education with real industry immersion.
                        Students gain technical expertise through online academics while simultaneously building
                        professional experience through structured IT industry internships.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="container">
            ...
            <div class="highlight-grid">
                ...
                <div class="highlight-item">
                    ...
                    <h4>Real IT industry internship throughout program</h4>
                </div>
            ...
            <div class="accordion" id="faqAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">
                            Q1. What makes SAGE university BCA with Internship different from online-only BCA?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. You gain both academic credentials and genuine workplace experience with established IT
                            companies during your studies. With academics there is internship for BCA students.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq2">
                            Q2. Is this degree valid for jobs and higher studies?
                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Yes. It is UGC approved online BCA Hons with internship, making it valid for both higher
                            studies and job plus it has the additional advantage of a documented BCA internship.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq3">
                            Q3. What kind of internships are provided in online BCA internship program?
                        </button>
                    </h2>
                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Structured internship with software companies, IT services, development agencies, and
                            tech startups for hands-on coding and project work.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq4">
                            Q4. Who benefits most from this online BCA Hons with Internship program?
                        </button>
                    </h2>
                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Students wanting both computing knowledge and early career experience, seeking stronger
                            employability and faster career launch.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq5">
                            Q5. What are the benefits of BCA with internship?
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq6">
                            Q6. What are the career options after BCA with Internship?
                        </button>
                    </h2>
                    <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Here are the career opportunities after BCA with internship: Software Developer, Full
                            Stack Developer, Mobile App Developer, Database Administrator, Quality Assurance Engineer,
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq7">
                            Q7. What is the duration of online Bachelor of Computer Applications Hons with Internship?
                        </button>
                    </h2>
                    <div id="faq7" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. The duration of online BCA (Hons.) with Internship program is 4 years.
                        </div>
                    </div>
                </div>
            </div>
