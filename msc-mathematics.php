        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">M.Sc in Mathematics</li>
                </ol>
            </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p style="font-size: 16px; line-height: 1.8; text-align: justify;">SAGE's online M.Sc Mathematics
                        offers advanced study in pure and applied mathematics, preparing students for research,
                        teaching, data science, analytics, and technical careers. Online delivery makes quality
                        mathematical education accessible regardless of location.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="container">
            ...
            <div class="highlight-grid">
                ...
                <div class="highlight-item">
                    ...
                    <h4>Prepare for career in Data Science, Cryptography, and Modeling</h4>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="career-grid">
                ...
                <div class="career-card">
                    ...
                    <h3>Mathematics Teacher / Lecturer</h3>
                </div>
                <div class="career-card">
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">
                            Q1. Is this M.Sc Mathematics online course valid for PhD?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Yes. SAGE University online M.Sc Mathematics is UGC-recognized and qualifies for PhD
                            admissions across India.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq2">
                            Q2. Can I prepare for NET/GATE?
                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Yes. Curriculum aligns with NET/GATE syllabi for exam preparation.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. Data science, finance, research, teaching, analytics, and technical industries.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq4">
                            Q4. Must I attend physical classes?
                        </button>
                    </h2>
                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body">
                            A. No. Completely online with video lectures, live sessions, and digital materials.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq5">
                            Q5. What is the eligibility criteria for Online M.Sc Mathematics?
                        </button>
                    </h2>
